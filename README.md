...
Paper badges use the format `year-venue/source-color`. Confirmed venues are shown when available; otherwise entries use `arXiv`, `Survey`, `Dataset`, or `Resource` to avoid overstating publication status.
...
- ![2025 arXiv](https://img.shields.io/badge/2025-arXiv-lightgrey) [Organize the Web: Constructing Domains Enhances Pre-Training Data Curation](https://arxiv.org/abs/2502.10341) - Topic/format domain construction for web corpora.
...
- ![2025 arXiv](https://img.shields.io/badge/2025-arXiv-lightgrey) [MASS: Mathematical Data Selection via Skill Graphs for Pretraining Large Language Models](https://arxiv.org/abs/2503.14917) - Skill-graph-based mathematical data selection.
...
- ![2023 arXiv](https://img.shields.io/badge/2023-arXiv-lightgrey) [Data Selection for Language Models via Importance Resampling](https://arxiv.org/abs/2302.03169) - DSIR data selection using target distribution matching.
...
- ![2024 arXiv](https://img.shields.io/badge/2024-arXiv-lightgrey) [What Makes Good Data for Alignment?](https://arxiv.org/abs/2312.15685) - Complexity, quality, diversity, and DEITA selection.
...
- ![2023 arXiv](https://img.shields.io/badge/2023-arXiv-lightgrey) [LIMA: Less Is More for Alignment](https://arxiv.org/abs/2305.11206) - Carefully curated 1K examples for supervised alignment.
...
- ![2023 Dataset](https://img.shields.io/badge/2023-Dataset-yellow) [UltraFeedback: Boosting Language Models with Scaled AI Feedback](https://arxiv.org/abs/2310.01377) - Large-scale AI feedback preference data.
...
- ![2022 arXiv](https://img.shields.io/badge/2022-arXiv-lightgrey) [Self-Instruct: Aligning Language Models with Self-Generated Instructions](https://arxiv.org/abs/2212.10560) - Pre-2023 anchor for self-generated instruction data.
...
- ![2023 arXiv](https://img.shields.io/badge/2023-arXiv-lightgrey) [The Curse of Recursion: Training on Generated Data Makes Models Forget](https://arxiv.org/abs/2305.17493) - Foundational model-collapse paper.
- ![2023 arXiv](https://img.shields.io/badge/2023-arXiv-lightgrey) [Self-Consuming Generative Models Go MAD](https://arxiv.org/abs/2307.01850) - Model autophagy disorder in generative loops.
...
- ![2024 arXiv](https://img.shields.io/badge/2024-arXiv-lightgrey) [Data Attribution for Text-to-Image Models by Unlearning Synthesized Images](https://arxiv.org/abs/2406.09408) - Attribution via simulated unlearning.
...
- ![2023 arXiv](https://img.shields.io/badge/2023-arXiv-lightgrey) [DataInf: Efficiently Estimating Data Influence in LoRA-tuned LLMs and Diffusion Models](https://arxiv.org/abs/2310.00902) - Influence approximation for PEFT and diffusion.
...
- ![2024 Dataset](https://img.shields.io/badge/2024-Dataset-yellow) [The WMDP Benchmark: Measuring and Reducing Malicious Use With Unlearning](https://arxiv.org/abs/2403.03218) - Hazardous-knowledge benchmark and representation unlearning.
- ![2024 arXiv](https://img.shields.io/badge/2024-arXiv-lightgrey) [Copyright Traps for Large Language Models](https://arxiv.org/abs/2402.09363) - Detecting training on protected content via traps.
...
- ![2023 Resource](https://img.shields.io/badge/2023-Resource-informational) [SILO Language Models: Isolating Legal Risk In a Nonparametric Datastore](https://arxiv.org/abs/2308.04430) - Legal-risk isolation via datastore.
...
- ![2023 Resource](https://img.shields.io/badge/2023-Resource-informational) [ARES: An Automated Evaluation Framework for Retrieval-Augmented Generation Systems](https://arxiv.org/abs/2311.09476) - Synthetic judges plus small human sets for RAG evaluation.
...
- ![2024 arXiv](https://img.shields.io/badge/2024-arXiv-lightgrey) [Data Attribution for Text-to-Image Models by Unlearning Synthesized Images](https://arxiv.org/abs/2406.09408) - Multimodal provenance/attribution.
...
- ![2022 arXiv](https://img.shields.io/badge/2022-arXiv-lightgrey) [Self-Instruct](https://arxiv.org/abs/2212.10560) - Synthetic instruction bootstrapping.
